...
namespace ChessBoard
{
    public class Board
    {
        ...
        {
            // Creating a bool placeBlackSquare and assigning it to true wich will be used to 
            // alternate the black and white squares when drawing the board
            bool placeBlackSquare = true;
            ...
            for (int i = 0; i < Rows; i++)
            {
                ...
                for (int j = 0; j < Columns; j++)
                {
                    ...
                    {
                        // if placeBlackSquare is true we will write out a black square
                        if (placeBlackSquare)
                        {
                            Console.Write(BlackSquare);
                        }
                        // placeBlackSquare was false so we will write out a white square instead
                        else
                        {
                    ...
                    placeBlackSquare = !placeBlackSquare;
                }
